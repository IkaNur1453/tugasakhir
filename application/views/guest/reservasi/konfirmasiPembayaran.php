                                ...
                                <div class="content-align-center">
                                    <div class="col-md-6">  
                                        <form action="<?= base_url('reservasi/prosesKonfirmasi')?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label>E-mail</label>
                                                <input type="text" placeholder="E-mail" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Jumlah Pembayaran" value="">
                                            </div>
                                            <div class="form-group">
                                                <label>Bank Tujuan</label>
                                                <input type="text" class="form-control" placeholder="Bank Tujuan" value="">
                                            </div>
                                            <div class="form-group">
                                                <label>Nama Rekening Pengirim</label>
                                                <input type="text" placeholder="Nama Rekening Pengirim" class="form-control" value="">
                                            </div>
                                            <div class="form-group">
